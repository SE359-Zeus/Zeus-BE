...
type IInventoryRepository interface {
	...
	GetPartTypeNameByID(ctx context.Context, id int32) (string, error)
	GetPartConditionNameByID(ctx context.Context, id int32) (string, error)
	...
	ListComponentStocks(ctx context.Context, params pagination.Params, status, q string, supplierID *uuid.UUID) ([]models.ComponentStock, *pagination.Meta, error)
